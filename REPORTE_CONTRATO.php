...
<body>
    ...
    <div align="CENTER"><font size="4" color="blue">REPORTE DE CONTRATO</font></div>
   ...
   <li class="dropdown">
    ...
    <header>REPORTE DE CONTRATO</header>
    <section>
        <center>
    <table border="0" align="center">
    	<tr>
            <td width="335"><input type="text" placeholder="Busca CONTRATO" id="bs-prod"/></td>
